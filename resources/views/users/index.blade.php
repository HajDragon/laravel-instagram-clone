...
<!--
|--------------------------------------------------------------------------
| Users Index/Search Page
|--------------------------------------------------------------------------
|
| This view displays a searchable list of all users in the application.
| Key features include:
|
| - Dynamic page title that changes based on search context
| - Search form with instant results
| - Responsive grid layout for user cards (1-3 columns depending on screen size)
| - User cards with profile image, name, follower count, title, and bio
| - Follow/Unfollow functionality with AJAX (no page refresh)
| - Verification badge display for verified users
| - Empty state handling with friendly message when no users found
| - Pagination support with search query preservation
| - Light/dark mode support throughout all UI elements
|
| JavaScript functionality:
| - Real-time follow/unfollow button state updates
| - CSRF token handling for secure requests
| - Responsive button styling changes based on follow state
|
| Routes used:
| - users.search: For search form submission
| - profile.show: For user profile links
| - users.index: For "View all users" link
| - /follow/{userId}: AJAX endpoint for follow/unfollow actions
|
-->
...
<!-- JavaScript for Follow/Unfollow Functionality (same as index page) -->
<script>
