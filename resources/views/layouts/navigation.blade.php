            ...
            <div class="flex">
                ...
                <div class="flex items-center ml-4">
                    <x-nav-link :href="route('profile.show', ['profile' => Auth::user()->id])" :active="request()->routeIs('profile.show')" class="text-lg flex items-center">
                        ...
                        <svg aria-label="Instagram" class="h-10 w-10 fill-current text-white" viewBox="0 0 24 24">
                        ...
                        <span class="ml-2 font-semibold tracking-wider text-white text-xl">Instagram</span>
                    </x-nav-link>
                </div>
